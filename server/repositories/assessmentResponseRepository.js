...
export const assessmentResponseRepository = new BaseRepository(
	"assessment_responses",
	"id"
);

assessmentResponseRepository.findResponseByAssessmentIdAndQuestionId =
	async function (assessmentId, questionId) {
		const query =
